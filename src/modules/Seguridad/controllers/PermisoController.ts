...
export class PermisoController {
    ...
    // POST /permiso/seed-impresiones
    static seedImpresiones = async (_req: Request, res: Response) => {
        try {
            const nuevos = [
                { modulo_permiso: 'impresiones', accion_permiso: 'menu' },
                { modulo_permiso: 'impresiones', accion_permiso: 'impresoras' },
                { modulo_permiso: 'impresiones', accion_permiso: 'trabajos_impresion' },
            ];
    ...
    // POST /permiso/seed-retos-ventas
    static seedRetosVentas = async (_req: Request, res: Response) => {
        try {
            const nuevos = [
    ...
    // POST /permiso/seed-gestion-pedidos
    static seedGestionPedidos = async (_req: Request, res: Response) => {
        try {
            const nuevos = [
                { modulo_permiso: 'chequeo', accion_permiso: 'tablero_chequeo' },
                { modulo_permiso: 'chequeo', accion_permiso: 'gestion_pedidos' },
            ];
