import { Cat_BancosRepository } from '../../repository/Catalogos/Cat_Bancos.repository';
import { ICat_Bancos, IUpdateCat_Bancos } from '../../interface/Catalogos/Cat_Bancos.interface';
