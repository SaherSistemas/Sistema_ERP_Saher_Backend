import { ICatCreateMetodoPago } from '../../interface/Catalogos/Cat_Metodo_Pago.interface';
import { Cat_Metodo_PagoRepository } from '../../repository/Catalogos/Cat_Metodo_Pago.repository';
