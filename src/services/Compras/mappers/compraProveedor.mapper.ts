...
export const mapCompraProveedor = makeMapper<any, CompraProveedorDTO>(
    {
        ...
        fecha_mercancia_recibida_proveedor: { from: 'fecha_mercancia_recibida_proveedor', map: asISO },
        ...
        inicio_de_checado: { from: 'inicio_de_checado', map: asISO },
        fin_de_checado: { from: 'fin_de_checado', map: asISO },
        inicio_acomodo_mercancia: { from: 'inicio_acomodo_mercancia', map: asISO },
        fin_acomodo_mercancia: { from: 'fin_acomodo_mercancia', map: asISO },
